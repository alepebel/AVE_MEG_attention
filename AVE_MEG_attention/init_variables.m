...
if quest_task
    init.exp_name = 'AVE_meg_questatt_exp';
else
    init.exp_name = 'AVE_meg_att_exp';
end
...
switch init.location
    ...
    case 'cubicle'
        rng('shuffle'); % Randomize seed of random number generator
        init.screenwidhsize = 53; % in c
        init.screen_width_resolution = 1280; %
        init.distance2screen = 56.0; % in cm
