...
function [Experimentalsession, block, path, outputFolder, dataFile] = subj_ID(init, quest_task);
...
if  ~quest_task
    if mod(block,2)
        ...
        % Use contrast of previous block
        params.contrast = Experimentalsession(block-1).params.contrast;
    end
end
