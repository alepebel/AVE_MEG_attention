function AVE_MEG_att(task)

% Alexis Perez-Bellido 10-5-2018
%% This is the second experiment of the AVE detection project.
% I have implemented a visual detection paradigm and a color discrimination
% task in odd and even blocks. 
...
[Experimentalsession, block, path, outputFolder, dataFile] = subj_ID(init, quest_task);
...
task_instructions(init, win, block, quest_task);
